...
<div class="picture">
	...
	<div class="post_operations actions">
		<span><a href="<?php echo $picture->you_like ? static::$action_unlike_link : static::$action_like_link; ?>&picture_id=<?php echo $picture->id; ?>"><?php echo $picture->you_like ? $lang[ 'unlike' ] : $lang[ 'like' ]; ?></a> <!-- &middot; <a href="share.php?picture_id=<?php echo $picture->id; ?>"><?php echo $lang[ 'share' ]; ?></a> --></span> &middot; <span class="automated_post">Uploaded <?php echo Utils::how_long_ago( $picture->upload_date ); ?></span>
	</div>
