		...
		<script type="text/javascript" src="views/<?php echo $theme; ?>/unauthenticated/scripts/compressed/lib/jquery-3.0.0.min.js"></script>
		<script type="text/javascript" src="https://js.stripe.com/v2/"></script>

		<script type="text/javascript" src="views/<?php echo $theme; ?>/unauthenticated/scripts/compressed/javascript.js"></script>
    </body>
</html>
<?php
	if ( isset( $DB ) ) {
