...
<div class="content">
    ...
    <div id='ppBody'>
        ...
        <div class='innerText'>We collect information from you when you register on our site, place an order, fill out a form, Open a Support Ticket or enter information on our site.</div>
        ...
        <div class='innerText'>all the sensitive information is being handled by and external PCI complaint payment gateway</div>
        ...
        <div class='innerText'>It's also important to note that we do not allow third-party behavioral tracking</div><span id='coppAct'></span><br /><div class='blueText'><strong>COPPA (Children Online Privacy Protection Act)</strong></div><br />
        ...
        <div class='innerText'>We do not specifically market to children under the age of 13 years old.</div><span id='ftcFip'></span><br /><div class='blueText'><strong>Fair Information Practices</strong></div><br />
        ...
        <div class='innerText'><br />We also agree to the Individual Redress Principle which requires that individuals have the right to legally pursue enforceable rights against data collectors and processors who fail to adhere to the law. This principle requires not only that individuals have enforceable rights against data users, but also that individuals have recourse to courts or government agencies to investigate and/or prosecute non-compliance by data processors.</div><span id='canSpam'></span><br /><div class='blueText'><strong>CAN SPAM Act</strong></div><br />
        ...
        <div class='innerText'><a href="mailto:support@webmediasolutionz.com">support@webmediasolutionz.com</a> and we will promptly remove you from <strong>ALL</strong> correspondence.</div><br /><span id='ourCon'></span><br /><div class='blueText'><strong>Contacting Us</strong></div><br />
        ...
        <div class='innerText'><a href="mamasita.webmediasolutionz.com">mamasita.webmediasolutionz.com</a></div>
        
        <div class='innerText'>1080 Bay St</div>Toronto, On M5S 0A5 
        
        <div class='innerText'>Canada</div>
        
        <div class='innerText'>
            <a href="mailto:support@webmediasolutionz.com">support@webmediasolutionz.com</a>
        </div>
        
        <div class='innerText'>
            <br />Last Edited on 2017-05-17</div>
        </div>
</div>
